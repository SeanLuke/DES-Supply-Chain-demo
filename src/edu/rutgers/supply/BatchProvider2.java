 ...
 */
public interface BatchProvider2 extends Named {
	...
	shortage of product).
     */
    //double feedTo(Channel r, double amt);

    /** Sends a request to this BatchProvider for a specified amount to be sent via a specified channel.
	The provider may send some amount immediately and put the rest on back-order, to be sent later.
     */
    ...
    default public void cancel(Order order) {}
}
