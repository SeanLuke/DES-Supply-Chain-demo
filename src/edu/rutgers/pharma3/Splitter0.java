...
public class Splitter0 extends Provider implements Receiver    {
    ...
    public Splitter0(SimState state, Entity typical)        {
        super(state, typical);
    }
    ...
    **/
    ...
    public String toString()
        {
        return "Splitter0@" + System.identityHashCode(this) + "(" + (getName() == null ? "" : getName()) + typical.getName() + ", " + typical + ")";
        }

    /** Does nothing.  There's no reason to step a Splitter0. */
